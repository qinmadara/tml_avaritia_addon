...
public class TaskAvaritiaCrossBow extends TaskCrossBowAttack {
    ...
    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath("tml_avaritia_addon", "avaritia_crossbow_attack");

    /** 索敌半径：对齐 TLM CROSS_BOW_RANGE 默认 64 */
    private static final float SEARCH_RADIUS = 64.0F;
